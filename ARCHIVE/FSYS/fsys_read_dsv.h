 ...
 *			   Simple functions convert the DSV data into a single column table of string tokens.
 *			   This can then be subdivided by the caller with domain specific information, sanitized and type converted.
