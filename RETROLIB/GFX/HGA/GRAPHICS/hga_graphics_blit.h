...
//blit_vram_bmp
		...
		//void blit_bmp_bmp(char* raster_destination, char* raster_source, uint16_t x, uint16_t y, uint16_t w, uint16_t h);

		//void blit_bmp_bmp(char* raster_destination, char* raster_source, char* raster_mask, uint16_t x, uint16_t y, uint16_t w, uint16_t h);
