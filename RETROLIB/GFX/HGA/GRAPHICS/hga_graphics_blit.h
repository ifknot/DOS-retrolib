...
namespace hga {
	...
	namespace graphics {
		...
		*/
		...
		void blit_bmp_bmp(char* raster_data1, char* raster_data2, uint16_t x, uint16_t y, uint16_t w, uint16_t h);

		void blit_bmp_bmp(char* raster_data1, char* raster_data2, char* raster_mask, uint16_t x, uint16_t y, uint16_t w, uint16_t h);
